...
class View implements ViewInterface
{
    ...
    protected $doctypes = array(
        self::DOCTYPE_HTML4_01_TRANSITIONAL => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">',
        self::DOCTYPE_HTML4_01_STRICT       => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">',
        self::DOCTYPE_HTML4_01_FRAMESET     => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Frameset//EN" "http://www.w3.org/TR/html4/frameset.dtd">',
        self::DOCTYPE_XHTML1_0_TRANSITIONAL => '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',
        self::DOCTYPE_XHTML1_0_STRICT       => '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">',
        self::DOCTYPE_XHTML1_0_FRAMESET     => '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">',
     ...
     * @var string
     */
    protected $title = 'Tlumx framework!!!';
     ...
     * @throws \InvalidArgumentException
     */
    public function setMeta($type = 'name', $typeValue ='', $content = '',array $modifiers = array()) 
    {
    ...
    public function registerWidget($name, \Closure $callable)
    {
        ...
        $this->widgets[$name] = function (array $params = array()) use ($callable) {
            static $instance;
            if (null === $instance) {
     ...
     * @throws \InvalidArgumentException
     */
    public function widget($name, array $params = array())
    {
        if(!isset($this->widgets[$name])) {
