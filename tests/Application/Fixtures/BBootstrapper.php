...
class BBootstrapper extends Bootstrapper
{
    ...
    public function postBootstrap(AppEvent $e)
    {
        return 'postBootstrap';
    }

    public function preRouting(AppEvent $e)
    {
        return 'preRouting';
    }

    public function postRouting(AppEvent $e)
    {
        return 'postRouting';
    }

    public function preDispatch(AppEvent $e)
    {
        return 'preDispatch';
    }

    public function postDispatch(AppEvent $e)
    {
        return 'postDispatch';
    }
}
